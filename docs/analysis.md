...
3. **Очищенная академическая версия (UNSW-Distrinet):**
Независимая исследовательская группа (Lisa Liu-Thorrold и др.) провела масштабную работу по исправлению CSE-CIC-IDS2018. Они доказали необходимость корректировки типов данных, удаления пустых значений (missing information) и дублирующихся записей для корректной работы алгоритмов машинного обучения.
**Исправленный датасет:** [Kaggle: Distrinet CSE-CIC-IDS2018](https://www.kaggle.com/datasets/dhoogla/distrinetcsecicids2018)
---
